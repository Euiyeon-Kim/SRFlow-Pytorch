...
class MultiStepLRRestart(_LRScheduler):
    def __init__(self, optimizer, milestones, restarts=None, weights=None, gamma=0.1,
                 clear_state=False, last_epoch=-1, lr_steps_invese=[]):
        ...
        self.restarts = restarts or [0]
        self.restart_weights = weights or [1]

        assert len(self.restarts) == len(self.restart_weights), 'restarts and their weights do not match.'

        super(MultiStepLRRestart, self).__init__(optimizer, last_epoch)
...
if __name__ == "__main__":
    ...
    scheduler = CosineAnnealingLRRestart(optimizer, T_period, eta_min=1e-7, restarts=restarts,
